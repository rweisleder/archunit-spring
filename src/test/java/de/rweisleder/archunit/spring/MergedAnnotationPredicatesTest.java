...
class MergedAnnotationPredicatesTest {
    ...
    @Test
    void springAnnotatedWith_provides_a_description() {
    ...
    @Test
    void springAnnotatedWith_accepts_class_with_annotation_directly_present_on_class() {
    ...
    @Test
    void springAnnotatedWith_accepts_class_with_annotation_meta_present_on_class() {
        JavaClass controllerClass = importClass(ControllerClass.class);
    ...
    @Test
    void springAnnotatedWith_rejects_class_with_annotation_not_present_on_class() {
        JavaClass controllerClass = importClass(ControllerClass.class);
    ...
    @Test
    void springAnnotatedWith_accepts_field_with_annotation_directly_present_on_field() {
    ...
    @Test
    void springAnnotatedWith_accepts_field_with_annotation_meta_present_on_field() {
        JavaClass classWithFieldAnnotation = importClass(ClassWithFieldAnnotation.class);
        JavaField optionalAutowiredField = classWithFieldAnnotation.getField("o");
    ...
    @Test
    void springAnnotatedWith_rejects_field_with_annotation_not_present_on_field() {
        JavaClass classWithFieldAnnotation = importClass(ClassWithFieldAnnotation.class);
        JavaField optionalAutowiredField = classWithFieldAnnotation.getField("o");
    ...
    @Test
    void springAnnotatedWith_accepts_constructor_with_annotation_directly_present_on_constructor() {
    ...
    @Test
    void springAnnotatedWith_accepts_constructor_with_annotation_meta_present_on_constructor() {
        JavaClass classWithConstructorAnnotation = importClass(ClassWithConstructorAnnotation.class);
        JavaConstructor optionalAutowiredConstructor = classWithConstructorAnnotation.getConstructor();
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Autowired.class);
        assertThat(predicate).accepts(optionalAutowiredConstructor);
    ...
    @Test
    void springAnnotatedWith_rejects_constructor_with_annotation_not_present_on_constructor() {
        JavaClass classWithConstructorAnnotation = importClass(ClassWithConstructorAnnotation.class);
        JavaConstructor optionalAutowiredConstructor = classWithConstructorAnnotation.getConstructor();
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Lazy.class);
    ...
    @Test
    void springAnnotatedWith_accepts_method_with_annotation_directly_present_on_method() {
    ...
    @Test
    void springAnnotatedWith_accepts_method_with_annotation_meta_present_on_method() {
        JavaClass classWithMethodAnnotation = importClass(ClassWithMethodAnnotation.class);
        JavaMethod getMappingMethod = classWithMethodAnnotation.getMethod("get");
    ...
    @Test
    void springAnnotatedWith_rejects_method_with_annotation_not_present_on_method() {
        JavaClass classWithMethodAnnotation = importClass(ClassWithMethodAnnotation.class);
        JavaMethod getMappingMethod = classWithMethodAnnotation.getMethod("get");
    ...
    @Test
    void springAnnotatedWith_accepts_constructor_parameter_with_annotation_directly_present_on_parameter() {
    ...
    @Test
    void springAnnotatedWith_accepts_constructor_parameter_with_annotation_meta_present_on_parameter() {
        JavaClass classWithConstructorParameterAnnotation = importClass(ClassWithConstructorParameterAnnotation.class);
        JavaParameter optionalAutowiredParameter = classWithConstructorParameterAnnotation.getConstructor(Object.class).getParameters().get(0);
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Autowired.class);
        assertThat(predicate).accepts(optionalAutowiredParameter);
    ...
    @Test
    void springAnnotatedWith_rejects_constructor_parameter_with_annotation_not_present_on_parameter() {
        JavaClass classWithConstructorParameterAnnotation = importClass(ClassWithConstructorParameterAnnotation.class);
        JavaParameter optionalAutowiredParameter = classWithConstructorParameterAnnotation.getConstructor(Object.class).getParameters().get(0);
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Lazy.class);
    ...
    @Test
    void springAnnotatedWith_accepts_method_parameter_with_annotation_directly_present_on_parameter() {
    ...
    @Test
    void springAnnotatedWith_accepts_method_parameter_with_annotation_meta_present_on_parameter() {
        JavaClass classWithMethodParameterAnnotation = importClass(ClassWithMethodParameterAnnotation.class);
        JavaParameter optionalAutowiredParameter = classWithMethodParameterAnnotation.getMethod("get", Object.class).getParameters().get(0);
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Autowired.class);
        assertThat(predicate).accepts(optionalAutowiredParameter);
    ...
    @Test
    void springAnnotatedWith_rejects_method_parameter_with_annotation_not_present_on_parameter() {
        JavaClass classWithMethodParameterAnnotation = importClass(ClassWithMethodParameterAnnotation.class);
        JavaParameter optionalAutowiredParameter = classWithMethodParameterAnnotation.getMethod("get", Object.class).getParameters().get(0);
        DescribedPredicate<CanBeAnnotated> predicate = springAnnotatedWith(Lazy.class);
        assertThat(predicate).rejects(optionalAutowiredParameter);
