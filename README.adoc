...
image:https://img.shields.io/maven-central/v/de.rweisleder/archunit-spring.svg[link="https://central.sonatype.com/artifact/de.rweisleder/archunit-spring", title="Maven Central"]
